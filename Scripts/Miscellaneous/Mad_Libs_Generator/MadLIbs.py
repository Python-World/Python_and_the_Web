...
print("Mad libs --------------\n")
print(f"One day my {adjective_for_friend} friend and I decided to go to the {noun_game} game in {city}.")
print(f"We really wanted to see the {team} play the {noun_game}.")
print(f"So, we were on  our way down to the {sports_shop_name} and bought some {sports_stuff}.")
print(f"We got into the game and it was a lot of fun. We ate some {food} and drank some {drink}.")
