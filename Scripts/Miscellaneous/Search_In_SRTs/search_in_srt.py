	...
	for filename in files:
		...
		for sub in subtitles:
			...
			if search_string in content.lower():
				...
				print(bcolors.BOLD,bcolors.OKGREEN,'CONTENT : ',bcolors.ENDC,content)
				print(bcolors.BOLD,bcolors.OKBLUE,'START TIME : ', bcolors.ENDC,sub.start)
				print(bcolors.BOLD,bcolors.HEADER,'FILE : ', bcolors.ENDC,filename,end='\n\n')
