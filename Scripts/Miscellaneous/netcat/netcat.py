...
def main():
    ...
    parser.add_argument("-l","--listen",type=bool,default=False,help="start a server")
    parser.add_argument("-H","--host",type=str,default="127.0.0.1",help="specify the host ip")
    parser.add_argument("-p","--port",type=int,default=1234,help="specify the port")
    parser.add_argument("-s","--shell",type=bool,default=False,help="get an interactive shell")
    parser.add_argument("-e","--execute",type=str,default=None,help="execute a single command")
    parser.add_argument("-u","--upload",type=bool,default=False,help="upload file to remote server")
    ...
    if listen:
        ...
        filename=input("Enter new file name if you want to rename uploaded file on server: ")
